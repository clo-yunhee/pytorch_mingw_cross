...
cmake_args="-DPYTHON_EXECUTABLE=`which python3` -DNATIVE_BUILD_DIR=$root/sleef-native -DCAFFE2_CUSTOM_PROTOC_EXECUTABLE=$root/protobuf-native/bin/protoc -DWITH_BLAS=open -DGLIBCXX_USE_CXX11_ABI=1 -DCMAKE_C_FLAGS=-D_WIN32_WINNT=_WIN32_WINNT_WIN7 -DCMAKE_CXX_FLAGS=-D_WIN32_WINNT=_WIN32_WINNT_WIN7 -DUSE_MKLDNN=OFF -DUSE_NNPACK=OFF -DUSE_QNNPACK=OFF -DUSE_PYTHON_QNNPACK=OFF -DUSE_FBGEMM=OFF -DUSE_EIGEN_FOR_BLAS=OFF"
